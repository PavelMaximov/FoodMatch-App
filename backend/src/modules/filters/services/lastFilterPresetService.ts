...
export interface LastFilterPayload { mode:'solo'|'paired'; dishRegisters?:string[]; cuisines?:string[]; moods?:string[]; diet?:string[]; exclusions?:string[]; matchedLastTime?:number; }
