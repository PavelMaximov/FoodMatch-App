...
class AppThemeColors {
  ...
  static const FoodMatchThemeColors light = FoodMatchThemeColors(
    ...
    modalBackground: Color(0xFFFFFBF9), modalBarrier: Color(0x8C000000), overlay: Color(0x8C000000),
  ...
  static const FoodMatchThemeColors dark = FoodMatchThemeColors(
    ...
    modalBackground: Color(0xFF17110F), modalBarrier: Color(0xA6000000), overlay: Color(0x8C000000),
