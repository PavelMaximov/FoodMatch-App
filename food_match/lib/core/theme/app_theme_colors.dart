...
class AppThemeColors {
  ...
  static const FoodMatchThemeColors light = FoodMatchThemeColors(
    ...
    dishCardBackground: Color(0xFFFFFFFF), dishCardBorder: Color(0xFFE5E5E5), metadataPillBackground: Color(0xFFFFFFFF), metadataIcon: Color(0xFFFF5B1C), favoriteActive: Color(0xFFFF5D33), favoriteInactive: Color(0xFF505050),
  ...
  static const FoodMatchThemeColors dark = FoodMatchThemeColors(
    ...
    inputBackground: Color(0xFF241B18), inputBorder: Color(0xFF4A3933), inputFocusedBorder: Color(0xFFFF7043),
    ...
    dishCardBackground: Color(0xFF261D1A), dishCardBorder: Color(0xFF3D302B), metadataPillBackground: Color(0xFF342822), metadataIcon: Color(0xFFFF8A5C), favoriteActive: Color(0xFFFF6A4A), favoriteInactive: Color(0xFFB8A9A1),
