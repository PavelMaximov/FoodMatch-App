...
export interface SoloSwipeFilter { dishRegisters: string[]; cuisines: string[]; moods: string[]; diet: string[]; exclusions: string[]; }
...
const filterSchema = new Schema<SoloSwipeFilter>({ dishRegisters:{type:[String],default:[]}, cuisines:{type:[String],default:[]}, moods:{type:[String],default:[]}, diet:{type:[String],default:[]}, exclusions:{type:[String],default:[]} },{_id:false});
