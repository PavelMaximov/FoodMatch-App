...
export interface SoloSwipeFilter { cuisines: string[]; moods: string[]; diet: string[]; exclusions: string[]; }
export interface SoloSwipeSessionDocument extends Document {
  ...
  matchedCount: number; lastActivityAt: Date; completedAt?: Date | null; createdAt: Date; updatedAt: Date;
}
const filterSchema = new Schema<SoloSwipeFilter>({ cuisines:{type:[String],default:[]}, moods:{type:[String],default:[]}, diet:{type:[String],default:[]}, exclusions:{type:[String],default:[]} },{_id:false});
